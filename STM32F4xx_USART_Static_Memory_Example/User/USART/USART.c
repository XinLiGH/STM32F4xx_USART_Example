...
void USART_Configuration(USART_TypeDef* USARTx, uint32_t BaudRate, uint16_t USART_IT)
{
  ...
  if(USARTx == USART1)
  {
#if USART1_BufferSize_Tx || USART1_BufferSize_Rx
#if USART1_BufferSize_Tx && USART1_BufferSize_Rx
...
#endif /* USART1_BufferSize_Rx */
#endif /* USART1_BufferSize_Tx */
#endif /* USART1_BufferSize_Tx && USART1_BufferSize_Rx */
#else
    return;
#endif /* USART1_BufferSize_Tx || USART1_BufferSize_Rx */
  }
  ...
  {
#if USART2_BufferSize_Tx || USART2_BufferSize_Rx
#if USART2_BufferSize_Tx && USART2_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART2_BufferSize_Tx
...
#endif /* USART2_BufferSize_Rx */
#endif /* USART2_BufferSize_Tx */
#endif /* USART2_BufferSize_Tx && USART2_BufferSize_Rx */
#else
    return;
#endif /* USART2_BufferSize_Tx || USART2_BufferSize_Rx */
  }
  ...
  {
#if USART3_BufferSize_Tx || USART3_BufferSize_Rx
#if USART3_BufferSize_Tx && USART3_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART3_BufferSize_Tx
...
#endif /* USART3_BufferSize_Rx */
#endif /* USART3_BufferSize_Tx */
#endif /* USART3_BufferSize_Tx && USART3_BufferSize_Rx */
#else
    return;
#endif /* USART3_BufferSize_Tx || USART3_BufferSize_Rx */
  }
  ...
  {
#if USART4_BufferSize_Tx || USART4_BufferSize_Rx
#if USART4_BufferSize_Tx && USART4_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART4_BufferSize_Tx
...
#endif /* USART4_BufferSize_Rx */
#endif /* USART4_BufferSize_Tx */
#endif /* USART4_BufferSize_Tx && USART4_BufferSize_Rx */
#else
    return;
#endif /* USART4_BufferSize_Tx || USART4_BufferSize_Rx */
  }
  ...
  {
#if USART5_BufferSize_Tx || USART5_BufferSize_Rx
#if USART5_BufferSize_Tx && USART5_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART5_BufferSize_Tx
...
#endif /* USART5_BufferSize_Rx */
#endif /* USART5_BufferSize_Tx */
#endif /* USART5_BufferSize_Tx && USART5_BufferSize_Rx */
#else
    return;
#endif /* USART5_BufferSize_Tx || USART5_BufferSize_Rx */
  }
  ...
  {
#if USART6_BufferSize_Tx || USART6_BufferSize_Rx
#if USART6_BufferSize_Tx && USART6_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART6_BufferSize_Tx
...
#endif /* USART6_BufferSize_Rx */
#endif /* USART6_BufferSize_Tx */
#endif /* USART6_BufferSize_Tx && USART6_BufferSize_Rx */
#else
    return;
#endif /* USART6_BufferSize_Tx || USART6_BufferSize_Rx */
  }
  ...
  {
#if USART7_BufferSize_Tx || USART7_BufferSize_Rx
#if USART7_BufferSize_Tx && USART7_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART7_BufferSize_Tx
...
#endif /* USART7_BufferSize_Rx */
#endif /* USART7_BufferSize_Tx */
#endif /* USART7_BufferSize_Tx && USART7_BufferSize_Rx */
#else
    return;
#endif /* USART7_BufferSize_Tx || USART7_BufferSize_Rx */
  }
  ...
  {
#if USART8_BufferSize_Tx || USART8_BufferSize_Rx
#if USART8_BufferSize_Tx && USART8_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART8_BufferSize_Tx
...
#endif /* USART8_BufferSize_Rx */
#endif /* USART8_BufferSize_Tx */
#endif /* USART8_BufferSize_Tx && USART8_BufferSize_Rx */
#else
    return;
#endif /* USART8_BufferSize_Tx || USART8_BufferSize_Rx */
  }
  ...
  {
#if USART9_BufferSize_Tx || USART9_BufferSize_Rx
#if USART9_BufferSize_Tx && USART9_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART9_BufferSize_Tx
...
#endif /* USART9_BufferSize_Rx */
#endif /* USART9_BufferSize_Tx */
#endif /* USART9_BufferSize_Tx && USART9_BufferSize_Rx */
#else
    return;
#endif /* USART9_BufferSize_Tx || USART9_BufferSize_Rx */
  }
  ...
  {
#if USART10_BufferSize_Tx || USART10_BufferSize_Rx
#if USART10_BufferSize_Tx && USART10_BufferSize_Rx
    USART_Mode = USART_Mode_Tx | USART_Mode_Rx;
#else
#if USART10_BufferSize_Tx
...
#endif /* USART10_BufferSize_Rx */
#endif /* USART10_BufferSize_Tx */
#endif /* USART10_BufferSize_Tx && USART10_BufferSize_Rx */
#else
    return;
#endif /* USART10_BufferSize_Tx || USART10_BufferSize_Rx */
  }
